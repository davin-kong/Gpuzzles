                ...
                if ($data->num_rows > 0) {
                    ...
                    while($row = $data->fetch_assoc()) {
                        echo '<tr>
                            <td>'.$row["id"].' </td>            
                                <td>'.$row["name"].' </span> </td>
                                <td><img class="thumbnailSize" src="'.'Images/index_images/'.$row["puzzle_image"].'" alt="'.$row["puzzle_image"].'"></td>
                                <td><a class="btn btn-warning btn-sm" href="modifyTopic.php?name='.$row["name"].'">Modify</a></td>                                  
                                <td><a class="btn btn-danger btn-sm" href="deleteTopic.php?name='.$row["name"].'">Delete</a></td> 
                            </tr>';
                    }//end while
                }//end if
                else {
